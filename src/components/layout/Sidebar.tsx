...
export const Sidebar = () => {
  ...
  return (
    <div className="hidden lg:flex flex-col w-72 bg-white dark:bg-dark-surface border-r border-gray-100 dark:border-black/20 min-h-[calc(100vh-4rem)] transition-colors duration-300">

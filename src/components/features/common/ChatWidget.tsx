    ...
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-80 md:w-96 bg-white dark:bg-dark-surface rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden flex flex-col h-[500px]"
          >
            {/* Telegram Header */}
            <div className="bg-white dark:bg-dark-surface p-3 flex items-center justify-between border-b border-gray-100 dark:border-black/20 z-10 cursor-pointer hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
            ...
            {/* Input Area */}
            <form onSubmit={handleSend} className="p-2 bg-white dark:bg-dark-surface border-t border-gray-100 dark:border-black/20 flex items-end gap-2">
      ...
      <button
        ...
        className={cn(
          ...
          isOpen 
            ? "bg-gray-200 text-gray-600 dark:bg-dark-surface dark:text-white" 
